...
export default function DisclaimerPage(): JSX.Element {
  return (
    <main className="max-w-4xl mx-auto px-6 py-16 text-gray-800">
      ...
      <p className="mb-6">
        At Nexplacers™, we are committed to delivering high-quality reverse recruiting, staffing, and career support
        services. Due to the nature of our business and the value delivered through strategy, time, and intellectual
        effort, we maintain a strict <strong>No Refund Policy</strong>.
      </p>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-2">1. No Refund on Any Plan</h2>
        <p className="mb-2">
          All payments made to Nexplacers™ for one-time packages, installment plans, or success-based services are
          non-refundable under all circumstances, including but not limited to:
        </p>
        ...
        <p className="mt-2">
          We advise all clients to read our service descriptions, terms, and success criteria thoroughly before
          proceeding.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-2">
          For hybrid or pay-after-placement plans:
        </p>
        <ul className="list-disc list-inside space-y-1">
          <li>
            The success fee is legally due once a candidate receives and accepts a job offer (including contract, W2,
            C2C, or direct-hire).
          </li>
          <li>
            Refusing to pay the agreed success fee after a successful placement may result in legal action and
            blacklisting from future support.
          </li>
          <li>
            Success fees are non-refundable, even if the candidate exits the job voluntarily or is terminated.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-2">
          We actively monitor and contest any unauthorized chargebacks or payment reversals. Clients who attempt to
          file false claims may face:
        </p>
        <ul className="list-disc list-inside space-y-1">
      ...
      <section className="mb-8">
        ...
        <p className="mb-2">
          If you opt for a monthly or installment plan:
        </p>
        <ul className="list-disc list-inside space-y-1">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            A service was never initiated by our team within 14 days of purchase and no interaction or onboarding took
            place
          </li>
        </ul>
        <p className="mt-2">
          All exceptions require written request to{" "}
          <a href="mailto:support@nexplacers.com" className="text-blue-600 underline">
      ...
      <section className="mb-8">
        ...
        <p className="mt-2">
          All disputes shall be subject to the exclusive jurisdiction of courts in the respective region.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          By making payment to Nexplacers™, you acknowledge that:
        </p>
        <ul className="list-disc list-inside space-y-1 mt-2">
          <li>You have read, understood, and agreed to this policy</li>
          <li>
            You waive any right to claim refund, partial refund, or cancellation except under documented exception
            scenarios
          </li>
      ...
      <div className="mt-10">
        <p className="font-semibold">
          📩 For all refund-related queries, email:
        </p>
        <p>
          <a href="mailto:support@nexplacers.com" className="text-blue-600 underline">
            support@nexplacers.com
